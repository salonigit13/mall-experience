  ...
  return (
    <div className="min-h-screen bg-[#FDFDFB]">
      ...
      <section className="relative h-screen flex items-center justify-center overflow-hidden">
        <img
          src={whyContent.hero.image}
          alt={whyContent.hero.title}
      ...
      {/* Story Sections - Light Background */}
      <section className="py-32 bg-[#FDFDFB]">
        <div className="container mx-auto px-8">
          {whyContent.story.map((item, index) => (
            <motion.div
              key={item.id}
              initial="hidden"
              whileInView="visible"
      ...
      {/* Stats - Light Alt Background */}
      <section className="py-32 bg-[#F5F5F0]">
        <div className="container mx-auto px-8">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-12">
            {whyContent.stats.map((stat, i) => (
