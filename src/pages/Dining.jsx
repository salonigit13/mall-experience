...
export default function Dining() {
  ...
  return (
    <div className="min-h-screen bg-[#FDFDFB]">
      {/* Hero - Dark */}
      <section id="dining" className="relative h-screen flex items-center justify-center overflow-hidden">
        <img
          src={diningContent.hero.image}
          alt={diningContent.hero.title}
      ...
      <section id="dining-story" className="py-32 bg-[#FDFDFB]">
        <div className="container mx-auto px-8">
          {diningContent.story.map((item, index) => (
            <motion.div
              key={item.id}
              initial="hidden"
              whileInView="visible"
      ...
      {/* Stats - Light Alt */}
      <section id="dining-stats" className="py-32 bg-[#F5F5F0]">
        <div className="container mx-auto px-8">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-12">
            {diningContent.stats.map((stat, i) => (
      ...
      {/* CTA - Dark */}
      <section id="dining-cta" className="py-32 bg-[#0a0a0a]">
        <motion.div
          ref={ref}
          initial={{ opacity: 0, y: 30 }}
          animate={isInView ? { opacity: 1, y: 0 } : {}}
